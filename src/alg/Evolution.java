...
public class Evolution {
	...
	/***
	 * Die Eingabe-Funktion, f�r ein Problem, das gel�st werden soll.
	 * @param gen
	 * @return
	 */
	...
	/**
	 * Funktion zum Testen einer L�sung
	...
	public static void evolve(int n) throws Exception{
		// TODO: sch�n machen - Schnittstelle f�r InputFunktionsklassen
		...
		for (Individuum individuum : population){
			// Bei Nullstellen-Problem m�sste man jetzt zuerst eine L�sung aus der Eingabefunktion holen
		...
		// Berechnen der Wahrsch. f�r jedes Individuum 
		...
		for (int i = 1; i<= Evolution.ANZAHL_KINDER; i++){
			...
			// Zufallsselektion - rangbasierte Seleketion f�r Minimierungsprobleme
			...
			while(neuesKind == null){
				...
				// ToDo: Eltern d�rfen nicht beide das gleiche Individuum sein
				
				// Schritt 8 - ein Kind durch Rekombination erzeugen
				
				// Schritt 9 - Kind gegebenenfalls mutieren
				
				// Schritt 10 - neues Kind der Kindergeneration hinzuf�gen
			}		
			
			// Schritt 13 - Bewerte alle Individuuen der Kindergeneration
			
			// Schritt 14 - �bergang auf die Nachfolgegeneration
	...
	public static Individuum selektiereElternteil(List<Individuum> population) throws Exception{
		...
		throw new Exception("Es wurde kein Individuum mit der gew�rfelten Zufallszahl gefunden. Dies kann nicht sein.");
	}
	...
	/***
	 * Berechnung der Wahrsch. f�r rangbasierte Selektion f�r Minimierungsporbleme
